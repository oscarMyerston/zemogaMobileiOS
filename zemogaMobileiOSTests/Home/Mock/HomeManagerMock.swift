...
class HomeManagerMock: IHomeManager {
    ...
    var isAddPosts = false
    var isRemoveAllPosts = false
    var isRemovePost = false
    ...
    var isEmptyPostsDB = false

    func getPosts(completion: @escaping zemogaMobileiOS.ModelCompletion) {
        if isInternalError {
    ...
    func fetchPostsFromLocalDB(completion: @escaping zemogaMobileiOS.ModelCompletion) {
        if isEmptyPostsDB {
            completion(.success([]))
    ...
    func addPosts(posts: zemogaMobileiOS.HomeModel.HomePost, completion: @escaping zemogaMobileiOS.ModelCompletion) {
        isAddPosts = true
        completion(.success("Posts added succesfully."))

    }

    func removeAllPosts(posts: [zemogaMobileiOS.HomeModel.HomePost], completion: @escaping zemogaMobileiOS.ModelCompletion) {
        isRemoveAllPosts = true
        completion(.success("Posts Removed succesfully."))

    }

    func removePost(post: zemogaMobileiOS.HomeModel.HomePost, completion: @escaping zemogaMobileiOS.ModelCompletion) {
        isRemovePost = true
        completion(.success("Post Removed succesfully."))
